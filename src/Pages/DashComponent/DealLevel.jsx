              ...
              <Table sx={{ minWidth: 350 }} aria-label="simple table">
                ...
                <TableBody>
                  ...
                  >
                    ...
                    <TableCell className="table-pad">Rs. 1,342.65</TableCell>
                    <TableCell className="table-pad ">
                      <a href={pdf} download>
                        <img src={pdf} alt="" className="w-6 m-auto" />
                      </a>
                    </TableCell>
                  </TableRow>
                  <TableRow
